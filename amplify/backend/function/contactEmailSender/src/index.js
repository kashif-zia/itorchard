...
exports.handler = async (event) => {
  const firstName = event.Records[0].dynamodb.NewImage.first_name.S;
  const lastName = event.Records[0].dynamodb.NewImage.last_name.S;
  const phoneNumber = event.Records[0].dynamodb.NewImage.phone_number.S;
  const companyName = event.Records[0].dynamodb.NewImage.company_name.S;
  const email = event.Records[0].dynamodb.NewImage.email.S;
  const description = event.Records[0].dynamodb.NewImage.description.S;
  const websiteURL = event.Records[0].dynamodb.NewImage.website_url.S;
